...
from nn_utils.general import flatten, reconstruct, exp_mask, add_reg_without_bias,\
    exp_mask_for_high_rank, mask_for_high_rank, add_var_reg
from nn_utils.general import selu
...
def generate_embedding_mat(dict_size, emb_len, init_mat=None, extra_mat=None,
    ...
    """
    return tf.get_variable("word_embedding", initializer=tf.constant(extra_mat, dtype=tf.float32))
